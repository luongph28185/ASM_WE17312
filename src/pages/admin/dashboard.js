...
<!-- ./Sidebar -->
<div class=" ml-[350px] mt-[100px]">
<a href="/book-add"><button class="rounded-lg border font-bold text-white bg-red-500 px-3 py-2 hover:border-green-200 hover:text-black"">Thêm</button></a>
<h2 class="text-center text-green-500 font-bold text-[50px] my-5">Quản Lý Hàng Hóa</h2>
<table class="border-separate border border-slate-500 w-[1000px]">
    <thead>
      <tr>
        <th class="border border-slate-300">STT</th>
        <th class="border border-slate-300">Tên</th>
        <th class="border border-slate-300">Ảnh</th>
    ...
    ${data.map(function(book, index){
        return /*html*/`
    <tr>
        <td class="border font-bold border-slate-300">${index+1}</td>
        <td class="border border-slate-300 pl-2">
        <a class="hover:text-blue-500 font-bold" href="/admin/books/${book.id}">${book.name}</a>
        </td>
        <td class="border border-slate-300 hover:bg-pink-200">
        <a href="/admin/books/${book.id}"> <img class="px-6 py-3" src="${book.images?.[0].medium_url}"/></a>
        </td>
        <td class="border border-slate-300">
        <a class="hover:text-blue-500 font-bold px-4" href="/admin/books/${book.id}">${book.original_price}</a>
        </td>
        <td class="flex space-x-3 items-center border border-slate-300 px-2">
        <button class="rounded-lg border font-bold text-white bg-red-500 px-4 py-2 hover:border-green-200 delete-btn hover:text-black "data-id="${book.id}">Xóa</button>
       <a href="/admin/books/${book.id}"> <button  class="rounded-lg border font-bold text-white bg-yellow-500 px-4 py-2 hover:border-green-200 hover:text-black" >sửa</button></a>
